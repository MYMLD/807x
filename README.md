...
## Clone the source
```bash
git clone -b openwrt-19.07 --single-branch https://github.com/immortalwrt/immortalwrt && cd immortalwrt
...
# Contributed
### See [CONTRIBUTED.md](https://github.com/immortalwrt/immortalwrt/blob/openwrt-19.07/CONTRIBUTED.md).

# License
### [GNU General Public License v3.0](https://github.com/immortalwrt/immortalwrt/blob/openwrt-19.07/LICENSE).
